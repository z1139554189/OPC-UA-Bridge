...
| 版本 | **`dashboard.html` = V1.2 正式版**（2026-06-05 发布，含 IIAS + 登录鉴权） |
| 测试版4 | `dashboard_test4.html`（2026-06-05，IIAS + 登录鉴权 admin/Admin_00） |
...
| 32 | 记忆文件路径错误（写到 workspace 根目录） | 未遵守项目记忆规则 | **记忆文件必须写在项目内 `OPC-UA-Bridge/.workbuddy/memory/`** |
